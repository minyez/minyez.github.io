...
Chirpy can render block quotes with `prompt-` class nicely. In pandoc,
HTML attributes of a block can be specified by adding `{:}` before or
after the element. For example,
